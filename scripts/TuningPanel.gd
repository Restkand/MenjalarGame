...
func _ready():
	...
	_help = Label.new()
	_help.text = "Klik kiri: pilih & arahkan (akar di beton: menembus)   Klik kanan: bercabang   X: putus sulur   Spasi: jeda   1/2: kecepatan\nWASD: geser   Roda: zoom   Tab: panel   R: ulang   Tahan V: peta risiko"
