...
func _draw():
	...
	# jaringan benih di Ruang01View, DIGELAPKAN searah (playtest pemilik:
	# vegetasi gelap, hanya ujung hidup yang menyala)
	var batang = Color("3E7A32")
	var daun = Color("4F8F32")
	var sebelum = null
